      ...
      `}
        ...
        <div>
          ...
          <body style={bodyStyle}>
            ...
            <div class="formTitle">Enter email to retrieve information.</div>

            <div class="progress" style={progressBar}>
              <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"/>
            </div>

            <form method="post" id="retrieval-form">
              ...
              <div class="form-group" style={textArea}>
                  <button type="submit" class="btn btn-primary">Fetch Registration</button>
              </div>
            </form>
